...
import AvatarImage from '../assets/avatarImage3.webp';
import { cardShadow, hoverEffect } from '../utils';
import Badge from './Badge';

const ProjectRecommendation = function ProjectRecommendation() {
    return (
        <RecommendProject area-label="RecommendProject">
            <CardContent>
                <Detail>
                    <InfoContainer>
                        <Avatar>
                ...
                <ProjectInfo>
                    Looking for a talented brand designer to create all the branding materials for
                    my new startup.
                </ProjectInfo>
                <PriceContainer>
